...
public:
    ...
    void setupUi(QMainWindow *gestion_ons)
    {
        ...
        pushButton->setGeometry(QRect(330, 410, 331, 23));
        pushButton_4 = new QPushButton(tab);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(40, 410, 281, 23));
        ...
        pushButton_2->setGeometry(QRect(20, 420, 281, 23));
        pushButton_3 = new QPushButton(tab_2);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(320, 420, 331, 23));
